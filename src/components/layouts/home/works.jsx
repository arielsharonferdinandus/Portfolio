    ...
    >
      ...
      <div className="flex gap-2 sm:gap-3 md:gap-6 items-center text-white w-8/9 sm:w-1/2 md:w-3/4">
        {companies.map((company, idx) => (
          <div
            key={idx}
            className="flex flex-col items-center text-center bg-[#959595] border-t-4 border-r-4 border-b-4 border-l-4 border-t-[#585858] border-r-[#585858] border-b-[#1b1b1b] border-l-[#1b1b1b] p-2 sm:p-4 md:p-6 lg:p-8 rounded-s max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl w-full">
